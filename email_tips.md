...
![A screenshot of an email that does not meet the guidelines above](https://cs167/cs167.github.io/blob/main/_assets/bad_email.png)


## What to do:
Here is an example of an email that includes all of the above. 
![A screenshot of an email that meets the above guidelines](https://cs167/cs167.github.io/blob/main/_assets/good_email.png)
